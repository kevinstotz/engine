...
--
-- Dumping data for table `ses_emailaddress`
--

LOCK TABLES `ses_emailaddress` WRITE;
/*!40000 ALTER TABLE `ses_emailaddress` DISABLE KEYS */;
/*!40000 ALTER TABLE `ses_emailaddress` ENABLE KEYS */;
UNLOCK TABLES;
