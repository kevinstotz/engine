...
--
-- Dumping data for table `ses_notification`
--

LOCK TABLES `ses_notification` WRITE;
/*!40000 ALTER TABLE `ses_notification` DISABLE KEYS */;
/*!40000 ALTER TABLE `ses_notification` ENABLE KEYS */;
UNLOCK TABLES;
