...
--
-- Dumping data for table `ses_register`
--

LOCK TABLES `ses_register` WRITE;
/*!40000 ALTER TABLE `ses_register` DISABLE KEYS */;
/*!40000 ALTER TABLE `ses_register` ENABLE KEYS */;
UNLOCK TABLES;
