...
--
-- Dumping data for table `ses_customuser_user_permissions`
--

LOCK TABLES `ses_customuser_user_permissions` WRITE;
/*!40000 ALTER TABLE `ses_customuser_user_permissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `ses_customuser_user_permissions` ENABLE KEYS */;
UNLOCK TABLES;
